...
export default function SignUpPage() {
  ...
  const { signup, googleLogin, githubLogin, isLoading } = useAuthStore()
  ...
  const isGithubConfigured =
    githubclientId && githubclientId !== 'your_github_client_id_here'
      ...
      <div className="hidden lg:flex flex-col items-center justify-center bg-secondary/5 p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md text-center">
          ...
          <p className="text-base-content/60 leading-relaxed">
            Create your free account and start messaging with anyone, anywhere,
            instantly.
          </p>
        </div>
      </div>
